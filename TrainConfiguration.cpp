...
struct ConfigurationNode Train_Configuration_Nodes[] = {
	...
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_TANK_PRESSURE, "Tank pressure", 0, 1600, 0),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_PIPE_PRESSURE, "Pipe pressure", 0, 1000, 0),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_BREAK_PRESSURE, "Break pressure", 0, 1000, 0),
	...
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_BUTTON_SIREN_HIGH, "Siren high tone button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_BUTTON_SIREN_LOW, "Siren low tone button"),
	...
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_CONTROLLER_SHUNT_POSITION, "Shunt controller position", 0, 6, 0),
	...
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_SWITCH_ENABLE, "Radio enable switch"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_SWITCH_NOISE, "Radio noise limit switch"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_SWITCH_MICROPHONE_ENABLE,"Microphone enable switch"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_BUTTON_RADIOSTOP, "Radiostop button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_BUTTON_EXT1, "External 1 button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_BUTTON_EXT2, "External 2 button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_BUTTON_EXT3, "External 3 button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_INDICATOR_ENABLE, "Enable radio indicator"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_RADIO_INDICATOR_SFN, "SFN radio indicator"),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_RADIO_SWITCH_CHANNEL, "Radio channel switch", 1, 10, 1),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_RADIO_SWITCH_VOLUME_LEVEL, "Radio volume level", 0, 15, 0),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_RADIO_SWITCH_LISTENING_LEVEL, "Radio listening level", 0, 127, 0),
};
