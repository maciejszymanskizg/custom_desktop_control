...
struct ConfigurationNode Train_Configuration_Nodes[] = {
	...
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_RADIO_SWITCH_CHANNEL, "Radio channel switch", 0, 9, 0),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_RADIO_SWITCH_VOLUME_LEVEL, "Radio volume level", 0, 127, 0),
