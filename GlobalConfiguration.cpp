...
struct ConfigurationNode Global_Configuration_Nodes[] = {
	...
	GLOBAL_CONFIGURATION_ENTRY(CONFIGURATION_ID_INPUT_THREAD_SLEEP_US, "Input thread sleep us", 0, 1000000, 1000),
	GLOBAL_CONFIGURATION_ENTRY(CONFIGURATION_ID_OUTPUT_THREAD_SLEEP_US, "Output thread sleep up", 0, 1000000, 1000),
