...
{
	pcf8575_0x20->sync(PCF8575::SYNC_FROM_PCF8575);

	PIN_TO_CONFIG(pcf8575_0x20, 0, conf, CONFIGURATION_ID_BUTTON_WHEELSLIP_COUNTER_ACTION);
	PIN_TO_CONFIG(pcf8575_0x20, 1, conf, CONFIGURATION_ID_SWITCH_ALERTER_INDICATOR_DIMM);
	PIN_TO_CONFIG(pcf8575_0x20, 2, conf, CONFIGURATION_ID_SWITCH_PANTHOGRAPH_B);
	PIN_TO_CONFIG(pcf8575_0x20, 3, conf, CONFIGURATION_ID_SWITCH_CONVERTER);
	PIN_TO_CONFIG(pcf8575_0x20, 4, conf, CONFIGURATION_ID_SWITCH_SHP_INDICATOR_DIMM);
	PIN_TO_CONFIG(pcf8575_0x20, 5, conf, CONFIGURATION_ID_SWITCH_PANTHOGRAPH_A);
	PIN_TO_CONFIG(pcf8575_0x20, 6, conf, CONFIGURATION_ID_SWITCH_COMPRESSOR);
	PIN_TO_CONFIG(pcf8575_0x20, 7, conf, CONFIGURATION_ID_SWITCH_TRAIN_HEATING);

	PIN_TO_CONFIG(pcf8575_0x20, 10, conf, CONFIGURATION_ID_BUTTON_LINE_CONTACTORS_DISABLE);
	PIN_TO_CONFIG(pcf8575_0x20, 11, conf, CONFIGURATION_ID_BUTTON_COMPRESSOR_OVERLOAD_UNLOCK);
	PIN_TO_CONFIG(pcf8575_0x20, 12, conf, CONFIGURATION_ID_BUTTON_TRACTION_ENGINE_OVERLOAD_UNLOCK);
	PIN_TO_CONFIG(pcf8575_0x20, 13, conf, CONFIGURATION_ID_BUTTON_CONVERTER_OVERLOAD_UNLOCK);
	PIN_TO_CONFIG(pcf8575_0x20, 14, conf, CONFIGURATION_ID_BUTTON_RELAXER);
	PIN_TO_CONFIG(pcf8575_0x20, 15, conf, CONFIGURATION_ID_BUTTON_RESERVE);
	PIN_TO_CONFIG(pcf8575_0x20, 16, conf, CONFIGURATION_ID_BUTTON_LINE_BREAKER_ENABLE);
	PIN_TO_CONFIG(pcf8575_0x20, 17, conf, CONFIGURATION_ID_BUTTON_LINE_BREAKER_DISABLE);
}
