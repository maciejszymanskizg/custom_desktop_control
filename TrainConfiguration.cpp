...
struct ConfigurationNode Train_Configuration_Nodes[] = {
	...
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_SWITCH_RADIO_NOISE, "Radio noise limit switch"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_SWITCH_RADIO_MICROPHONE_ENABLE,"Microphone enable switch"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_SWITCH_RADIOSTOP, "Radiostop button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_BUTTON_RADIO_EXT1, "External 1 button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_BUTTON_RADIO_EXT2, "External 2 button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_BUTTON_RADIO_EXT3, "External 3 button"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_INDICATOR_RADIO_ENABLE, "Enable radio indicator"),
	TRAIN_CONFIG_ENTRY_2_STATE(CONFIGURATION_ID_INDICATOR_RADIO_SFN, "SFN radio indicator"),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_SWITCH_RADIO_CHANNEL, "Radio channel switch", 1, 10, 1),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_SWITCH_RADIO_VOLUME_LEVEL, "Radio volume level", 0, 15, 0),
	TRAIN_CONFIG_ENTRY(CONFIGURATION_ID_SWITCH_RADIO_LISTENING_LEVEL, "Radio listening level", 0, 127, 0),
};
